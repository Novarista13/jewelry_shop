        ...
        <Animation>
          <Row className="animate-type">
            ...
            <Col className="my-auto">
              <h1
                className="my-4"
                style={{ color: "#f3839b", fontWeight: 600 }}
              >
                About Us
              </h1>
              ...
              <p>
                We source the finest materials, from ethically mined gemstones
                to high-quality metals, ensuring that each creation is not only
              ...
              <p>
                ...
                understand that choosing the perfect piece of jewelry can be a
                deeply personal and meaningful experience. That's why we are
                committed to providing customization options, and a comfortable
